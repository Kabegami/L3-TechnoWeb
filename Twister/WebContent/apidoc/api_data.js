define({ "api": [
  ...
  },
  {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "from",
            "description": "<p>id de l'utilisateur concerné (-1 si page principale et qu'on veut tout avoir)</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
            "optional": false,
            "field": "id_max",
            "description": "<p>-1 si pas de limite</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
          ...
          },
          {
            ...
            "optional": false,
            "field": "nb",
            "description": "<p>nombre de messages à retourner (-1 si pas de limite)</p>"
          }
        ]
      }
    },
    ...
    "filename": "src/servlets/ListMessagesUserServlet.java",
    "groupTitle": "Message"
  },
  {
    "type": "get",
  ...
  },
  {
    "type": "post",
    "url": "/usr/pass",
    "title": "Récupérer mot de passe par mail",
    "version": "0.1.0",
      ...
      "fields": {
        "ErrorJSON": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "1",
            "description": "<p>Adresse email non trouvée</p>"
          }
        ]
      }
    },
    "filename": "src/servlets/RecoverPasswordServlet.java",
    "groupTitle": "User"
  },
  {
    "type": "post",
